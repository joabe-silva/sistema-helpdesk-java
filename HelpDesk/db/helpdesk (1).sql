...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13/11/2023 às 22:09
...
--
-- Estrutura para tabela `def_usuario_perfil`
--

CREATE TABLE `def_usuario_perfil` (
  `ID` int(11) NOT NULL,
  `DESCRICAO` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Despejando dados para a tabela `def_usuario_perfil`
--

INSERT INTO `def_usuario_perfil` (`ID`, `DESCRICAO`) VALUES
(1, 'ADM'),
(2, 'CLIENTE');
...
--
-- Estrutura para tabela `def_usuario_situacao`
--

CREATE TABLE `def_usuario_situacao` (
  `ID` int(11) NOT NULL,
  `DESCRICAO` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Despejando dados para a tabela `def_usuario_situacao`
--

INSERT INTO `def_usuario_situacao` (`ID`, `DESCRICAO`) VALUES
(1, 'ATIVO'),
(2, 'INATIVO');
...
(1, 'JOABE', '123', 'JOABE SILVA', 1, 1),
(2, 'IVAN', '123', 'IVANILSON', 2, 1),
(3, 'DANIEL', '123', 'DANIEL', 1, 2);
...
--
-- Índices de tabela `def_usuario_perfil`
--
ALTER TABLE `def_usuario_perfil`
  ADD PRIMARY KEY (`ID`);

--
-- Índices de tabela `def_usuario_situacao`
--
ALTER TABLE `def_usuario_situacao`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT de tabela `def_usuario_perfil`
--
ALTER TABLE `def_usuario_perfil`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `def_usuario_situacao`
--
ALTER TABLE `def_usuario_situacao`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_perfil` FOREIGN KEY (`PERFIL`) REFERENCES `def_usuario_perfil` (`ID`),
  ADD CONSTRAINT `fk_situacao` FOREIGN KEY (`SITUACAO`) REFERENCES `def_usuario_situacao` (`ID`);
COMMIT;
