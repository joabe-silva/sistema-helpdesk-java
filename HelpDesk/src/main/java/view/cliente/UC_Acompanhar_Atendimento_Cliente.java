 ...
 * @author ERNANI
 */
public class UC_Acompanhar_Atendimento_Cliente extends javax.swing.JInternalFrame {
     ...
     */
    public UC_Acompanhar_Atendimento_Cliente() {
        initComponents();
    ...
    public UC_Acompanhar_Atendimento_Cliente(String id) {
        initComponents();
